...
class GOGService:
    ...
    async def get_deals(self, limit: int = 20) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            # Используем правильный endpoint для GOG
            response = await client.get(
                "https://api.gog.com/v2/products",
                params={
                    "sort": "discount:desc",
                    "limit": limit,
                    "page": 1,
                    "field": "id,title,slug,description,price,images,genres"
                }
            )
    ...
    async def get_free_games(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            # Используем правильный endpoint для бесплатных игр
            response = await client.get(
                "https://api.gog.com/v2/products",
                params={
                    "price": "free",
                    ...
                    "limit": 10,
                    "page": 1,
                    "field": "id,title,slug,description,images,genres"
                }
            )
    ...
    async def search_games(self, query: str, limit: int = 10) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            response = await client.get(
                f"{self.store_url}/products/filter/search",
                params={
                    "query": query,
                    "limit": limit,
                    "page": 1,
    ...
    async def get_classic_games(self, limit: int = 15) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            # Ищем классические игры по тегам
            response = await client.get(
                f"{self.store_url}/products/filter",
                params={
                    "genre": "classic",
                    "limit": limit,
                    "page": 1,
